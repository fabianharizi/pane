...
// This hook is used to implement the "Rectangle" tool. 
// It needs a condition to be active

export default function useRectangleTool(boardRef, enableArea, disableArea, addElement, active) {
  ...
  useEffect(() => {
    ...
    enableArea(mouse.startX, mouse.startY, mouse.x, mouse.y, "rectangle")
